...
('FJK1-B (325mm)', 'FJK1-B (325mm)', 'FJK1-B 견인기 325mm 모델', 'FJK1-B Traction Machine 325mm model', 
 ...
 '["고효율", "안정성", "내구성"]', '["High Efficiency", "Stability", "Durability"]', true),
...
('FJK2 – B450KG (240mm)', 'FJK2 – B450KG (240mm)', 'FJK2 견인기 B450KG 240mm 모델', 'FJK2 Traction Machine B450KG 240mm model', 
 ...
 '["고효율", "컴팩트", "내구성"]', '["High Efficiency", "Compact", "Durability"]', true),
...
('FJE1 제어 캐비닛', 'FJE1 CONTROL CABINET', 'FJE1 제어 캐비닛 - 스마트 제어 시스템', 'FJE1 Control Cabinet - Smart control system', 
 ...
 '["앱 원격 지원", "IoT 원격 모니터링", "통신 인코더", "자동 튜닝", "저소음 설계"]', 
 '["Remote technical support through APP", "Remote monitoring through IoT", "Communication encoder supported", "Balance coefficient auto-tuning", "Noise reduction design <50dBA"]', true),
...
('FJE2 제어 캐비닛', 'FJE2 CONTROL CABINET', 'FJE2 제어 캐비닛 - 고급 제어 시스템', 'FJE2 Control Cabinet - Advanced control system', 
 ...
 '["48층 표준", "듀플렉스 군관리", "자동 도어 제어", "소방 운전", "UPS 지원", "종합 진단"]', 
 '["Standard: 48 floors, full collective", "Duplex onboard group control", "Automatic door control mode", "Selectable fireman operation", "UPS support for rescue operation", "Comprehensive trip diagnostics"]', true);